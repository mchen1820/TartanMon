...
# locates mouse on screen
def detect_mouse(hand, list_of_fingers, wScr):
    ...
    elif(list_of_fingers[1] ==1 and list_of_fingers[2] == 1 and 
         list_of_fingers[3] == 0):
        return True, ((index_tip_mirrored_x,index_tip_y))
    
    return False , (0,0)

# finds distance between wrists
...
# detects 1st battle move
def detect_fist_palm(left_hand,right_hand):
    left_hand_list = left_hand["lmList"]
    right_hand_list = right_hand["lmList"]
    index_knuckle_dif = ((left_hand_list[5][0]- right_hand_list[5][0])**2 + 
                         (left_hand_list[5][1]- right_hand_list[5][1])**2) ** 0.5 
    middle_knuckle_dif = ((left_hand_list[9][0]- right_hand_list[9][0])**2 + 
                          (left_hand_list[9][1]- right_hand_list[9][1])**2) ** 0.5 
    ring_knuckle_dif = ((left_hand_list[13][0]- right_hand_list[13][0])**2 + 
                        (left_hand_list[13][1]- right_hand_list[13][1])**2) ** 0.5 
    pinky_knuckle_dif = ((left_hand_list[17][0]- right_hand_list[17][0])**2 + 
                         (left_hand_list[17][1]- right_hand_list[17][1])**2) ** 0.5 

    if(index_knuckle_dif<200 and middle_knuckle_dif<200 and ring_knuckle_dif<200 
       and pinky_knuckle_dif<200):
        if(fist_palm_tip_help(left_hand_list,right_hand_list)):
            return True
        return False
    return False

# detect 2nd battle move
def detect_triangle(left_hand, right_hand):
    left_hand_list = left_hand["lmList"]
    right_hand_list = right_hand["lmList"]

    thumb_distance = ((left_hand_list[4][0]- right_hand_list[4][0])**2 + 
                      (left_hand_list[4][1]- right_hand_list[4][1])**2) ** 0.5 
    index_distance = ((left_hand_list[8][0]- right_hand_list[8][0])**2 + 
                      (left_hand_list[8][1]- right_hand_list[8][1])**2) ** 0.5
    ...
    return (thumb_distance<150 and index_distance<150 and 
            abs(index_avg_y -thumb_avg_y) > 350 and 
            abs(index_avg_x -thumb_avg_x)<500)

# detect 3rd battle move
...
# detects 4th battle move motion
...
# detect 1st part of reselect Tartanmon move
...
# detect 2nd part of reselect Tartanmon move
